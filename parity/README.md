...
Android 앱은 디버그 인텐트 extra `imanagerai.fixture.zeroDelay=true` (`imanager.fixture.zeroDelay=true` 및 `starmanager.fixture.zeroDelay=true` 호환)와
`imanagerai.fixture.resetState=true` (`imanager.fixture.resetState=true` 및 `starmanager.fixture.resetState=true` 호환), 그리고 `composer.*`, `preview.*`, `settings.*`, `tab.*`
